...
@Component({
    selector: 'app-signup',
    standalone: true,
    imports: [NgClass, SignupInformationComponent, SignupPreferencesComponent, LogoMoviePosterComponent, NgOptimizedImage, SignupProgressionComponent, SignupPasswordComponent, RouterLink, SignupConfirmationComponent, SignupConfirmationComponent],
